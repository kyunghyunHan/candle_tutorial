...
#[derive(Clone)]
pub struct Dataset {
    pub train_votes: Tensor,//train data
    pub train_results: Tensor,
    pub test_votes: Tensor,//test data
...
fn train(m: Dataset, dev: &Device) -> anyhow::Result<MultiLevelPerceptron> {
    let train_results = m.train_results.to_device(dev)?; //디바이스
